 ...
 * @author danodic
 */
public class VerticalBlur extends PipelineStage {

    private static final String VERTEX_SHADER_PATH = "shaders/simple.vert";
    private static final String FRAGMENT_SHADER_PATH = "shaders/vertical_blur.frag";
    ...
    public VerticalBlur(Integer screenHeight, Integer screenWidth) {
